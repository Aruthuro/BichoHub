...
import br.edu.bichohub.ui.components.EstadoSolicitacao
...
@Composable
fun MinhasSolicitacoesScreen(onShowSnackbar: (String) -> Unit) {
                            ...
                            Card(modifier = Modifier.fillMaxWidth()) {
                                Column(modifier = Modifier.padding(12.dp)) {
                                    Row(
                                        ...
                                        Text(
                                            EstadoSolicitacao.entries.toTypedArray()[sol.estado].estado,
